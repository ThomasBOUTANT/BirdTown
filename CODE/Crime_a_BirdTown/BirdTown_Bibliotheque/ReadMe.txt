========================================================================
    BIBLIOTHÈQUE STATIQUE : Vue d'ensemble du projet BirdTown_Bibliotheque
========================================================================

AppWizard a créé ce projet de bibliothèque BirdTown_Bibliotheque à votre intention.

Aucun fichier source n'a été créé dans le cadre de votre projet.


BirdTown_Bibliotheque.vcxproj
...
BirdTown_Bibliotheque.vcxproj.filters
